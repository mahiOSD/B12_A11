          ...
          return (
            ...
            >
              ...
              <div className="space-y-1 text-gray-700">
                <p><span className="font-semibold">Chef Name:</span> {order.chefName || "N/A"}</p>
                <p><span className="font-semibold">Chef ID:</span> {order.chefId || "N/A"}</p>
                <p><span className="font-semibold">Quantity:</span> {order.quantity}</p>
                <p><span className="font-semibold">Price:</span> ${totalPrice}</p>
                <p><span className="font-semibold">Order Status:</span> <span className="capitalize">{order.orderStatus}</span></p>
                <p><span className="font-semibold">Payment Status:</span> <span className="capitalize">{order.paymentStatus}</span></p>
                <p><span className="font-semibold">Delivery Time:</span> {order.orderTime ? new Date(order.orderTime).toLocaleString() : "N/A"}</p>
              </div>
