...
const Meals = () => {
  ...
  const handleDetails = (id) => {
    if (user) navigate(`/meal/${id}`);
    else navigate("/login", { state: { from: `/meal/${id}` } });
  };
  ...
  <div
    key={meal._id ? meal._id.toString() : index}
          ...
          >
            ...
            <div className="p-5">
              ...
              <div className="text-sm text-gray-600 space-y-1">
                <p><span className="font-semibold text-gray-800">Chef:</span> {meal.chefName}</p>
                <p><span className="font-semibold text-gray-800">Chef ID:</span> {meal.chefId}</p>
                <p><span className="font-semibold text-gray-800">Area:</span> {meal.deliveryArea}</p>
                <p className="text-yellow-500 font-bold">⭐ {meal.rating || "N/A"}</p>
              </div>
